  ...
  const articles: Article[] = [
    {
      ...
      content: (
        <div className="space-y-6 text-right">
          <p className="text-xl font-bold text-white">איך מזהים כשלים לפני שהם הופכים לנזק בלתי הפיך?</p>
          <p>ליקויי בנייה הם לא רק עניין אסתטי. הם פצצה מתקתקת שעלולה לעלות לכם מאות אלפי שקלים. הנה הליקויים שמהנדסי אופקים מוצאים כמעט בכל בדיקה:</p>
          <div className="grid gap-4">
            <div className="p-5 bg-white/5 rounded-2xl border border-white/10">
              <h5 className="font-bold text-blue-400 text-lg mb-2">1. כשלי איטום בחדרים רטובים</h5>
              <p>שיפועים הפוכים במקלחות או איטום חסר מתחת לריצוף מובילים לרטיבות קפילארית שמטפסת בקירות.</p>
            </div>
            <div className="p-5 bg-white/5 rounded-2xl border border-white/10">
              <h5 className="font-bold text-blue-400 text-lg mb-2">2. סטייה במישוריות הריצוף</h5>
              <p>אריחים בולטים (שיניים) או חללים מתחת לאריח ("צליל חלול") שיובילו לשבירתם בעתיד.</p>
            </div>
            <div className="p-5 bg-white/5 rounded-2xl border border-white/10">
              <h5 className="font-bold text-blue-400 text-lg mb-2">3. סדקים נימיים מול סדקים מבניים</h5>
              <p>המהנדס שלנו יודע להבחין בין סדק של התכווצות טיח לבין סדק המעיד על שקיעת יסודות.</p>
            </div>
          </div>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="space-y-6 text-right">
          <p className="text-xl font-bold text-white">שקיפות מלאה במחיר - השקעה קטנה שחוסכת ענק.</p>
          <p>מחיר בדק בית נקבע לפי שעות עבודת המהנדס בשטח ומורכבות הפקת הדוח. הנה המחירון המומלץ שלנו:</p>
          ...
          <p className="text-gray-400 italic text-sm">* המחירים כוללים מע"מ וכוללים בדיקה תרמית מקיפה לאיתור נזילות.</p>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="space-y-6 text-right">
          <p className="text-xl font-bold text-white">דוח המהנדס הוא הנשק שלכם מול הקבלן בבית המשפט.</p>
          <p>כאשר קבלן מסרב לתקן ליקויים, הדרך היחידה לקבל פיצוי או תיקון היא באמצעות תביעה משפטית המגובה בחוות דעת מומחה.</p>
          <div className="p-6 bg-blue-600/5 rounded-3xl border-2 border-blue-500/20">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-300">
              ...
              <li>הערכת עלות תיקון מנומקת (לפי מחירון דקל).</li>
              <li>צילומים מתועדים של כל כשל בשטח.</li>
            </ul>
          </div>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="space-y-6 text-right">
          <p className="text-xl font-bold text-white">אל תתפשרו על פחות ממהנדס בניין (B.Sc).</p>
          <p>בשוק קיימים "בודקים" רבים שהם הנדסאים או קבלנים לשעבר. למרות הניסיון שלהם, רק מהנדס מוסמך להפיק חוות דעת הנדסית בנושאי שלד ויציבות.</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
             <div className="p-4 bg-gray-800 rounded-2xl border border-white/5">
                <span className="text-blue-400 font-bold block mb-1">המהנדס שלנו:</span>
                <p className="text-sm text-gray-300">מוסמך לאשר יציבות מבנית, מבין לעומק עומסים ותקני בטון.</p>
             </div>
             <div className="p-4 bg-gray-800 rounded-2xl border border-white/5">
                <span className="text-red-400 font-bold block mb-1">בודק רגיל:</span>
                <p className="text-sm text-gray-300">מסתכל על גמר (צבע, ריצוף) אך עלול לפספס כשלים קונסטרוקטיביים חמורים.</p>
             </div>
          </div>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="space-y-6 text-right">
          <p className="text-xl font-bold text-white">טכנולוגיית אינפרא-אדום לשירות הבית שלכם.</p>
          <p>רטיבות סמויה היא האויב השקט. היא גורמת לקורוזיה בברזלי הזיון של השלד ומזיקה לבריאות הדיירים (עובש).</p>
          <div className="p-6 bg-blue-600/10 rounded-3xl border border-blue-500/20">
             <h5 className="font-black text-white mb-2">מה אנחנו בודקים?</h5>
             <ul className="list-disc list-inside space-y-2 text-gray-300">
               <li>מיפוי רטיבות בכל קירות הבית בעזרת FLIR.</li>
               <li>בדיקת לחץ בצנרת המים (דליפה סמויה).</li>
               <li>איתור כשלי איטום במרפסות ובחלונות.</li>
               <li>בדיקת רטיבות קפילארית (עלייה מהמצע).</li>
             </ul>
          </div>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="space-y-6 text-right">
          <p className="text-xl font-bold text-white">מסירת דירה היא אירוע משפטי מחייב - היו מוכנים.</p>
          <p>הקבלן ילחץ עליכם לחתום על "פרוטוקול מסירה" שבו אתם מאשרים שקיבלתם את הדירה תקינה. אל תחתמו בלי ליווי מהנדס!</p>
          <p className="bg-gray-800 p-5 rounded-2xl border-r-4 border-blue-500 text-gray-200">
            <strong>חשוב לדעת:</strong> ברגע שחתמתם ללא הסתייגויות הנדסיות, יהיה לכם קשה מאוד להוכיח שהליקויים לא נגרמו על ידכם במהלך המעבר. המהנדס שלנו ינסח עבורכם את הנספח ההנדסי לפרוטוקול המסירה.
          </p>
        </div>
      )
    }
        ...
        {selectedArticle && (
          <div className="space-y-8">
            ...
            <div className="prose prose-invert max-w-none text-gray-300 leading-relaxed text-lg">
              ...
              <div className="h-24 md:h-32"></div> {/* "Safety breathing room" for scrolling */}
            </div>
          </div>
        )}
      </Modal>
