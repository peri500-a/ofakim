  ...
  return (
    <section className="relative min-h-screen min-h-[100dvh] flex items-center justify-center bg-cover bg-center text-white overflow-hidden py-24 md:py-0" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1541888946425-d81bb19480c5?auto=format&fit=crop&w=1920&q=80')", backgroundAttachment: 'scroll' }}>
      ...
      <div className="relative container mx-auto px-6 text-center z-10 pt-12 md:pt-20">
        ...
        {/* H1 for SEO - Strategic keyword placement */}
        <h1 className="text-3xl xs:text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-black leading-[1.1] md:leading-[0.9] mb-6 md:mb-10 tracking-normal filter drop-shadow-2xl animate-slide-up max-w-5xl mx-auto">
          <span className="block text-white mb-2">בדק בית וביקורת מבנים ע״י</span>
        ...
        <div className="max-w-3xl mx-auto mb-10 md:mb-12">
          <p className="text-base sm:text-xl md:text-2xl text-gray-400 font-medium leading-relaxed drop-shadow-lg px-2">
            אל תתפשרו על פחות ממהנדס רשוי המשמש מומחה מטעם בתי משפט. איתור ליקויי בניה מקצועי הוא המפתח לשקט הנפשי שלכם.
          </p>
        </div>

        {/* Trust Badges */}
        <ul className="flex flex-wrap justify-center gap-3 sm:gap-6 mb-12 md:mb-16 animate-fade-in" aria-label="יתרונות בולטים">
           <li className="flex items-center gap-2 bg-white/5 backdrop-blur-md px-4 py-2 rounded-full border border-white/10 shadow-lg hover:bg-white/10 transition-colors">
              ...
              <span className="text-xs sm:text-sm font-black text-gray-200 uppercase tracking-wide">מהנדס בדק בית מוסמך</span>
           </li>
           <li className="flex items-center gap-2 bg-white/5 backdrop-blur-md px-4 py-2 rounded-full border border-white/10 shadow-lg hover:bg-white/10 transition-colors">
              <span className="text-blue-500 text-sm sm:text-base" aria-hidden="true">✓</span>
              <span className="text-xs sm:text-sm font-black text-gray-200 uppercase tracking-wide">ביקורת מבנים הנדסית</span>
           </li>
           <li className="flex items-center gap-2 bg-white/5 backdrop-blur-md px-4 py-2 rounded-full border border-white/10 shadow-lg hover:bg-white/10 transition-colors">
              <span className="text-blue-500 text-sm sm:text-base" aria-hidden="true">✓</span>
              <span className="text-xs sm:text-sm font-black text-gray-200 uppercase tracking-wide">איתור נזילות תרמי</span>
           </li>
        </ul>
