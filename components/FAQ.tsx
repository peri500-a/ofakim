  ...
  const faqs = [
    {
      ...
      answer: 'חשוב לחפש המלצות מאומתות בגוגל וברשתות החברתיות. באופקים הנדסה, אנו גאים במאות לקוחות מרוצים שקיבלו שירות ממהנדסים רשומים.',
    },
    {
    ...
    },
    {
      ...
      answer: 'בהחלט. כל דוח שאנו מפיקים כולל פירוט הליקויים, צילומים, הפניה לתקן הישראלי הרלוונטי והערכת עלות לתיקון הליקוי לפי מחירי שוק מקובלים. זהו מסמך קביל ומשמעותי לניהול מו"מ מול קבלן או מוכר.',
    },
  ];
